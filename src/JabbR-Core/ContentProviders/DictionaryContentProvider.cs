...
namespace JabbR_Core.ContentProviders
{
    public class DictionaryContentProvider : CollapsibleContentProvider
    {
        ...
        {
            return uri.AbsoluteUri.StartsWith("http://www.dictionary.reference.com", StringComparison.OrdinalIgnoreCase) ||
                   uri.AbsoluteUri.StartsWith("http://www.dictionary.com", StringComparison.OrdinalIgnoreCase) ||
                   uri.AbsoluteUri.StartsWith("https://www.dictionary.reference.com", StringComparison.OrdinalIgnoreCase) ||
                   uri.AbsoluteUri.StartsWith("https://www.dictionary.com", StringComparison.OrdinalIgnoreCase);
        }
