...
namespace JabbR_Core.ContentProviders
{
    public class NugetNuggetContentProvider : CollapsibleContentProvider
    {
        ...
        {
            var packageDetail =
                _nugetURLRegex.Match(responseUri.AbsoluteUri).ToString(); // .Matches(responseUri.AbsoluteUri).GetEnumerator();
        ...
        public override bool IsValidContent(Uri uri)
        {
            return
                ...
                uri.AbsoluteUri.StartsWith("https://nuget.org", StringComparison.OrdinalIgnoreCase) ||
                uri.AbsoluteUri.StartsWith("https://www.nuget.org", StringComparison.OrdinalIgnoreCase);
        }
    }
}