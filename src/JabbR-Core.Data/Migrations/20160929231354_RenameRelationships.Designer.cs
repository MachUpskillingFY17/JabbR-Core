...
namespace JabbRCore.Migrations
{
    ...
    partial class RenameRelationships
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("JabbR_Core.Data.Models.UserRoom", b =>
                {
            ...
            modelBuilder.Entity("JabbR_Core.Data.Models.UserRoomAllowed", b =>
                {
                    b.Property<int>("ChatRoomKey")
                        .HasColumnName("ChatRoom_Key");
                    ...
                    b.ToTable("UserRoomAllowed");
                });

            modelBuilder.Entity("JabbR_Core.Data.Models.UserRoomOwner", b =>
                {
                    b.Property<int>("ChatRoomKey")
                        .HasColumnName("ChatRoom_Key");
